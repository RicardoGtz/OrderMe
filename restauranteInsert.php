...
<body>
	<div class="contenedor">
        ...
        <p>ID del restaurante:</p><input type="text" nme="id_restaurante" required maxlength="7" value=""><br>
        <p>Nombre de Restaurante:</p><input type="text" nme="id_restaurante" required maxlength="40" value=""><br>        
