				...
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						<div class="modal-body">
								...
								<input tabindex="1" aria-describedby="basic-addon2" aria-label="Usuario" class="form-control input-sm rounded" id="r_var1" maxlength="7" onkeypress="" placeholder="Usuario" required="" type="text" value="<?php echo $id_orden ?>" readonly/>
								<label>
									ID de Sucursal:
								</label>
								<input tabindex="2" aria-describedby="basic-addon2" aria-label="Usuario" class="form-control input-sm rounded" id="r_var1" maxlength="7" onkeypress="" placeholder="Usuario" required="" type="text" value="<?php echo $id_sucursal ?>" readonly/>
								<label>
									Fecha:
								</label>
								<input tabindex="3" aria-describedby="basic-addon2" aria-label="Usuario" class="form-control input-sm rounded" id="r_var1" maxlength="7" onkeypress="" placeholder="Usuario" required="" type="date" name="fecha" />
								<label>
									Numero de mesa:
								</label>
								<input tabindex="4" aria-describedby="basic-addon2" aria-label="Usuario" class="form-control input-sm rounded" id="r_var1" maxlength="7" onkeypress="" placeholder="Usuario" required="" type="text"  />
								<label>
									Total:
								</label>
								<input tabindex="4" aria-describedby="basic-addon2" aria-label="Usuario" class="form-control input-sm rounded" id="r_var1" maxlength="7" onkeypress="" placeholder="Usuario" required="" type="text"  />
