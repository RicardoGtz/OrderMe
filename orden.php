...
<body>
    ...
    <div class="animated fadeIn retraso-2 mx-auto">
        ...
        <div class=" mx-auto Negro espacio-abajo">
            ...
            <!-- Articulos -->
            <p class="mediano text-center">A continuacion, se mostrarán todas las ordenes creadas para los distintos restaurantes y sucursales.</p>
            <?php
            ...
            ?>
            <div class="col-lg-10 col-md-10 col-sm-10 text-center mx-auto quitar-float espacio-arriba espacio-abajo" id="tabla">
