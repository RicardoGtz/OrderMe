		        	...
		        	<div class="modal-dialog modal-lg" role="document">
        				<div class="modal-content">
				            <div class="modal-body">
				                ...
				                <input tabindex="2" aria-describedby="basic-addon2" aria-label="Usuario" class="form-control input-sm rounded" id="r_var1" maxlength="7" onkeypress="" placeholder="Usuario" required="" type="text" value="<?php echo $row[0] ?>" />
				                <label>
				                    Nombre:
				                </label>
				                ...
				                <input tabindex="5" aria-describedby="basic-addon2" aria-label="Contraseña" class="form-control input-sm rounded" id="r_var3" maxlength="10" onkeypress="" placeholder="Contraseña" required="" type="password" value="<?php echo $row[2] ?>"/>
				                <label>
				                    Correo:
				                </label>
				                <input tabindex="4" aria-describedby="basic-addon2" aria-label="Correo" class="form-control input-sm rounded" id="r_var4" maxlength="40" placeholder="Correo@" required="" type="text" value="<?php echo $row[3] ?>"/>
				                <label>
				                    Telefono:
				                </label>
				                <input tabindex="6" aria-describedby="basic-addon2" aria-label="Telefono" class="form-control input-sm rounded" id="r_var5" maxlength="10" onkeypress="return ;" placeholder="Telefono" required="" type="text" value="<?php echo $row[4] ?>"/>
				                <label>
				                    Id de la sucursal:
				                </label>
				                <input  tabindex="7" aria-describedby="basic-addon2" aria-label="Numero de tarjeta" class="form-control input-sm rounded" id="r_var6" maxlength="16" onkeypress="" placeholder="" required="" type="text" value="<?php echo $row[5] ?>"/>
				            </div>
    ...
    $(document).ready(function() {
        ...
        $('#actualizar').click(function() {
            ...
            if(var1 != "" &&
                ...
                var5 != "" &&
                var6 != "" ){
            	alertify.confirm('Actualizar cambios', '¿Desea guardar los cambios?', function(){ actualizar_empleado(cadena,tabla); }
